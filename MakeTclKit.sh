...
mkdir AmazonGlacierLibWrapper.vfs/lib64
unzip -qq -d AmazonGlacierLibWrapper.vfs/lib64 BuildData/Tclxml3.1-Linux64.zip
unzip -qq -d AmazonGlacierLibWrapper.vfs/lib BuildData/Tclxml3.1-Linux32.zip
