...
public class PrintToFilePrintJob implements CancelablePrintJob {
    ...
    private PrintToFileService service;
    ...
    PrintToFilePrintJob(PrintToFileService service) {
    ...
    public void print(Doc doc, PrintRequestAttributeSet attributes)
          throws PrintException {
              ...
              if (flavor == null || (!service.isDocFlavorSupported(flavor))) {
                  notifyEvent(PrintJobEvent.JOB_FAILED);
                  throw new PrintException("invalid flavor"+flavor);
              }
