 ...
 *  Created       : Thu Nov 26 09:35:13 2015
 *  Last Modified : <151126.1244>
 *
 *  Description	
 *
 *  Notes
...
public class PrintToFileService extends StreamPrintService {
    ...
    public PrintToFileService(OutputStream out) {
        super(out);
    }
    
    public String getOutputFormat() {
        return PrintToFilePrinterFactory.psMimeType;
    }
    
    
    public DocFlavor[] getSupportedDocFlavors() {
        return PrintToFilePrinterFactory.getFlavors();
    }
    
    public DocPrintJob createPrintJob() {
        return new PrintToFilePrintJob(this);
    }
    
    public String getName() {
        return "Postscript output to file";
    }
    ...
    public String toString() {
        return "PrintToFileService: " + getName();
    }
    ...
    public boolean equals(Object obj) {
        return (obj == this ||
                (obj instanceof PrintToFileService &&
                 ((PrintToFileService)obj).getName().equals(getName())));
    }
